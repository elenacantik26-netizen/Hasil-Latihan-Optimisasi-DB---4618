...
class Course(models.Model):
    ...
    class Meta:
        ...
        # Lab 7: Index untuk kolom yang sering dipakai filter/order
        indexes = [
...
class CourseMember(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['course_id'], name='idx_member_course'),
            models.Index(fields=['user_id'], name='idx_member_user'),
        ]
