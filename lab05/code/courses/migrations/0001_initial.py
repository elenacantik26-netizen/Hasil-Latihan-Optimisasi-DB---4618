# Generated by Django 5.1.15 on 2026-04-21 03:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['course_id'], name='idx_content_course'),
        ),
        migrations.AddIndex(
            model_name='coursemember',
            index=models.Index(fields=['course_id'], name='idx_member_course'),
        ),
        migrations.AddIndex(
            model_name='coursemember',
            index=models.Index(fields=['user_id'], name='idx_member_user'),
        ),
        migrations.AddIndex(
            model_name='comment',
